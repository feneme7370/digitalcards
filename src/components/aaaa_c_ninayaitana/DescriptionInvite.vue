...
<template>
  <div class="grid grid-cols-1 gap-12 w-full text-rose-300 fill-pink-800 py-20">
    ...
    <img class="rounded-full mx-auto border-2 border-pink-200" src="/aaaa_c_ninayaitana/images/images/images_4.jpeg" alt="" data-aos="zoom-in">

    <h2 class="text-center text-lg px-2 bangers-font tracking-wider" data-aos="fade-up">¡¡ 🎂 Queremos invitarte a festejar nuestro primer añito 🎉 !!</h2>
